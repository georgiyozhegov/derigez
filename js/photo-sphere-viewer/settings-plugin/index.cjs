...
var _SettingsPlugin = class _SettingsPlugin extends import_core5.AbstractPlugin {
...
_SettingsPlugin.id = "settings";
_SettingsPlugin.VERSION = "5.14.1";
var SettingsPlugin = _SettingsPlugin;
