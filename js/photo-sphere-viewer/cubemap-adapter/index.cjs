/*!
 * Photo Sphere Viewer / Cubemap Adapter 5.14.1
...
var _CubemapAdapter = class _CubemapAdapter extends import_core2.AbstractAdapter {
  static withConfig(config) {
    return [_CubemapAdapter, config];
  }
...
_CubemapAdapter.id = "cubemap";
_CubemapAdapter.VERSION = "5.14.1";
_CubemapAdapter.supportsDownload = false;
var CubemapAdapter = _CubemapAdapter;
