...
var _VideoPlugin = class _VideoPlugin extends import_core7.AbstractConfigurablePlugin {
  ...
  __onKeyPress(e) {
    if (e.matches(import_core7.CONSTANTS.KEY_CODES.Space)) {
      this.playPause();
      e.preventDefault();
    }
  }
...
_VideoPlugin.id = "video";
_VideoPlugin.VERSION = "5.14.1";
_VideoPlugin.configParser = getConfig;
_VideoPlugin.readonlyOptions = Object.keys(getConfig.defaults);
var VideoPlugin = _VideoPlugin;
