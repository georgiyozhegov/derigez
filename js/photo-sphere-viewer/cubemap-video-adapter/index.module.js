/*!
 * Photo Sphere Viewer / Cubemap Video Adapter 5.14.1
...
var _CubemapVideoAdapter = class _CubemapVideoAdapter extends AbstractVideoAdapter {
  static withConfig(config) {
    return [_CubemapVideoAdapter, config];
  }
...
_CubemapVideoAdapter.id = "cubemap-video";
_CubemapVideoAdapter.VERSION = "5.14.1";
var CubemapVideoAdapter = _CubemapVideoAdapter;
export {
  CubemapVideoAdapter
};
