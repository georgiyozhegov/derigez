/*!
 * Photo Sphere Viewer / Visible Range Plugin 5.14.1
...
var _VisibleRangePlugin = class _VisibleRangePlugin extends import_core.AbstractConfigurablePlugin {
  static withConfig(config) {
    return [_VisibleRangePlugin, config];
  }
...
_VisibleRangePlugin.id = "visible-range";
_VisibleRangePlugin.VERSION = "5.14.1";
_VisibleRangePlugin.configParser = getConfig;
_VisibleRangePlugin.readonlyOptions = [
  "horizontalRange",
  "verticalRange"
];
var VisibleRangePlugin = _VisibleRangePlugin;
